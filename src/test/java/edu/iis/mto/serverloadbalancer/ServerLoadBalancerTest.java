...
public class ServerLoadBalancerTest {
	...
	@Test
	public void balancingOneServerWithOneSlotCapacity_addOneSlotVm() {
		Server theServer = a(server().withCapacity(1));
	...
	@Test
	public void vmShuldBeBalancedOnLessLoadedServerFirst() {
	...
	@Test
	public void balancingServerWithNotEnoughRoom_shouldNotBeFillesWithTheVm() {
